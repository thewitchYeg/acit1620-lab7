...
function setup() {
    ...
    getNumberInput().addEventListener('input', (e) => {
        ...
        // Check if the input value is not empty and is a valid positive integer
        if (inputValue !== '' && /^\d+$/.test(inputValue)) {
            // Restart the game with the specified number of tries
            tries = parseInt(inputValue, 10);
